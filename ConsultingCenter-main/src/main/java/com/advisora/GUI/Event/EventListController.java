        ...
        try {
            ...
            listEvents.setCellFactory(list -> new ListCell<>() {
                ...
                protected void updateItem(Event item, boolean empty) {
                    ...
                    VBox card = buildEventCard(item);
                    card.setMaxWidth(Double.MAX_VALUE);
                    card.prefWidthProperty().bind(list.widthProperty().subtract(26));
                    setGraphic(card);
                }
            });
            listEvents.setPlaceholder(new Label("Aucun evenement."));
            ...
            listBookings.setCellFactory(list -> new ListCell<>() {
                ...
                protected void updateItem(EventBooking item, boolean empty) {
                    ...
                    setText(null);
                    setContentDisplay(ContentDisplay.GRAPHIC_ONLY);
                    VBox card = buildBookingCard(item);
                    card.setMaxWidth(Double.MAX_VALUE);
                    card.prefWidthProperty().bind(list.widthProperty().subtract(26));
                    setGraphic(card);
                }
            });
            listBookings.setPlaceholder(new Label("Aucune reservation."));
