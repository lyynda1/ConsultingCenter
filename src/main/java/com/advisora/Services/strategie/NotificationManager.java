...
public class NotificationManager {
    ...
    public void addNotification(Notification notification) {
        ...
        // Add to inâ€‘memory list (visible only to Admin/Gerant per original logic)
    ...
    public void loadNotificationsForUser(UserRole role, Integer userId) throws SQLException {
        ...
        try (Connection cnx = MyConnection.getInstance().getConnection();
            ...
            throw new RuntimeException("Erreur chargement notifications pour rÃ´le " + role + ": " + e.getMessage(), e);
        }
    }
