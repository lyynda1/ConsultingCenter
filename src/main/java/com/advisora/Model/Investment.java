...
public class Investment {
    ...
    public String getCommentaireInv() { return commentaireInv; }
    public void setCommentaireInv(String commentaireInv) { this.commentaireInv = commentaireInv; }
    public Time getDureeInv() { return dureeInv; }
    public void setDureeInv(Time dureeInv) { this.dureeInv = dureeInv; }
    public double getBud_minInv() { return bud_minInv; }
    public void setBud_minInv(double bud_minInv) { this.bud_minInv = bud_minInv; }
    public double getBud_maxInv() { return bud_maxInv; }
    public void setBud_maxInv(double bud_maxInv) { this.bud_maxInv = bud_maxInv; }
    public String getCurrencyInv() { return currencyInv; }
    public void setCurrencyInv(String currencyInv) { this.currencyInv = currencyInv; }
